...
return (
    <div className="navbar">
        <img src={logo} alt="logo" width='130' height='60' className="nav-mob-img"/>
        ...
        <div className="nav-connect"><AnchorLink className="anchor-link" offset={50} href="#contact">Reach Me</AnchorLink></div>
    </div>
);
};
